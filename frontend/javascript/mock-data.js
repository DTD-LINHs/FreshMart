...
const MOCK_NHOMHANG = [
  ...
  {
    MaNhom: "NH04",
    TenNhom: "Sữa & sản phẩm từ sữa",
    GhiChu: "Sữa tươi, sữa chua",
  },
...
const MOCK_SANPHAM = [
  ...
  },
  {
    ...
    MaNhom: "NH03",
    image:
      "https://images.unsplash.com/photo-1695683948382-868cd8d516fe?w=400&h=300&fit=crop",
  },
  {
    MaSP: "SP04",
    TenSP: "Fresh Milk",
    ...
    MaNhom: "NH04",
    image:
      "https://plus.unsplash.com/premium_photo-1694481099872-29a6ece2672c?w=400&h=300&fit=crop",
  },
  {
    MaSP: "SP05",
    TenSP: "Orange Juice",
  ...
  },
  {
    ...
    MaNhom: "NH01",
    image:
      "https://plus.unsplash.com/premium_photo-1689344314069-b60bf06d564c?w=400&h=300&fit=crop",
  },
  {
    MaSP: "SP08",
    TenSP: "CocaCola",
  ...
  },
  {
    ...
    MaNhom: "NH02",
    image:
      "https://images.unsplash.com/photo-1633380110125-f6e685676160?w=400&h=300&fit=crop",
  },
  {
    MaSP: "SP11",
    TenSP: "Mung Bean Sprouts",
    DonViTinh: "kg",
    GiaBan: 0.8,
    SoLuongTon: 50,
    HSD: "2026-05-10",
    MaNhom: "NH02",
    image:
      "https://images.unsplash.com/photo-1645762854600-42d298660501?w=400&h=300&fit=crop",
  },
  {
    MaSP: "SP12",
    TenSP: "Chicken Breast",
    DonViTinh: "kg",
    GiaBan: 6.5,
    SoLuongTon: 25,
    HSD: "2025-11-30",
    MaNhom: "NH03",
    image:
      "https://images.unsplash.com/photo-1604503468506-a8da13d82571?w=400&h=300&fit=crop",
  },
];
...
const MOCK_PHUONGTHUCTT = [
  {
    MaPT: "PT01",
    TenPT: "Tiền mặt",
    MoTa: "Thanh toán bằng tiền mặt tại quầy",
  },
...
const MOCK_KHUYENMAI = [
  ...
  },
  {
    ...
    NgayBatDau: "2026-05-08",
    NgayKetThuc: "2026-05-10",
  },
];

// --- AP_DUNG_KM (Promotion Application) ---
const MOCK_AP_DUNG_KM = [
  { MaKM: "KM01", MaSP: "SP01", MucGiam: 0.5 },
  { MaKM: "KM01", MaSP: "SP05", MucGiam: 0.3 },
  { MaKM: "KM02", MaSP: "SP03", MucGiam: 2.0 },
];
...
const MOCK_NHACUNGCAP = [
  {
    MaNCC: "NCC01",
    TenNCC: "Công ty TNHH Thực phẩm Sạch",
    DiaChi: "123 Lê Lợi, Q1, TP.HCM",
    SDT: "0281234567",
    Email: "thucphamsach@email.com",
  },
  {
    MaNCC: "NCC02",
    TenNCC: "Nông trại Đà Lạt Xanh",
    DiaChi: "456 Trần Phú, Đà Lạt",
    SDT: "0631234567",
    Email: "dalatxanh@email.com",
  },
  {
    MaNCC: "NCC03",
    TenNCC: "Công ty CP Đồ uống Việt",
    DiaChi: "789 Nguyễn Huệ, Q1, TP.HCM",
    SDT: "0281234999",
    Email: "douongviet@email.com",
  },
];
...
const MOCK_CHITIETHOADON = [
  { MaHD: "HD01", MaSP: "SP01", SoLuong: 2, DonGia: 3.0 },
  { MaHD: "HD01", MaSP: "SP04", SoLuong: 3, DonGia: 1.2 },
  { MaHD: "HD01", MaSP: "SP05", SoLuong: 2, DonGia: 2.0 },
  { MaHD: "HD02", MaSP: "SP03", SoLuong: 2, DonGia: 12.0 },
  { MaHD: "HD02", MaSP: "SP06", SoLuong: 3, DonGia: 1.8 },
  { MaHD: "HD03", MaSP: "SP02", SoLuong: 2, DonGia: 2.5 },
  { MaHD: "HD03", MaSP: "SP08", SoLuong: 5, DonGia: 1.0 },
  { MaHD: "HD04", MaSP: "SP03", SoLuong: 3, DonGia: 12.0 },
  { MaHD: "HD04", MaSP: "SP07", SoLuong: 2, DonGia: 5.0 },
  { MaHD: "HD04", MaSP: "SP04", SoLuong: 5, DonGia: 1.2 },
  { MaHD: "HD05", MaSP: "SP09", SoLuong: 3, DonGia: 1.5 },
  { MaHD: "HD05", MaSP: "SP10", SoLuong: 4, DonGia: 1.2 },
  { MaHD: "HD05", MaSP: "SP05", SoLuong: 5, DonGia: 2.0 },
];
...
function getActivePromotions() {
  const today = new Date().toISOString().split("T")[0];
  return MOCK_KHUYENMAI.filter(
    (km) => km.NgayBatDau <= today && today <= km.NgayKetThuc,
  );
}
